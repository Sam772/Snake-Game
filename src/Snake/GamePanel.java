...
public class GamePanel extends JPanel implements ActionListener {
    ...
    static final int SCREEN_WIDTH = 800; // width of window
    static final int SCREEN_HEIGHT = 800; // height of window
    static final int UNIT_SIZE = 50; // item size
        ...
        if (running) {
            ...
            for (int i = 0; i < bodyParts; i++) {
                if (i == 0) {
                    ...
                    // this line of code changes the colours of the snake randomly
    ...
    public void newApple() {
        // generate apples when it is called
